			...
			<div class="security-info">
				...
				<table>
					...
					<tr>
						...
						<td>
							${data.email ? `<a href="profile.html">修改邮箱</a>` : 	`<a href="profile.html">设置邮箱</a>`}
						</td>
					</tr>
					<tr>
						<td>绑定手机</td>
						<td>${data.mobile || ''}</td>
						<td>
							${data.mobile ? `<a href="profile.html">修改手机</a>` : `<a href="register-mobile.html">绑定手机</a>`}
						</td>
					</tr>
				</table>
			</div>
			...
			<div class="security-level">
				...
				<table>
					<tr>
						...
						<td>身份认证</td>
						<td>用于提升账号的安全性和认证级别，认证后的有卖家记录的账号不能修改认证信息</td>
						<td>${data.identity ? `<a href="#">查看</a>` : `<a href="#">认证</a>`}</td>
					</tr>
					<tr>
						<td>
						...
						<td>用户密码</td>
						<td>用户密码设置===================</td>
						<td>${data.password ? `<a href="#">修改</a>` : `<a href="#">设置</a>`}</td>
					</tr>
					<tr>
						<td>
						...
						<td>密保问题</td>
						<td>密保问题===================</td>
						<td>${data.secretQuestion ? `<a href="#">修改</a>` : `<a href="#">设置</a>`}</td>
					</tr>
					<tr>
						<td>
							<i class="${data.mobile ? 'ok' :'alert'}"></i>
							<div>${data.mobile ? '已设置' :'未设置'}</div>
						</td>
						<td>绑定手机</td>
						<td>绑定手机===================</td>
						<td>${data.mobile ? `<a href="#">修改</a>` : `<a href="#">设置</a>`}</td>
					</tr>
				</table>
			</div>
